...
- [[5] 페이지별 기능](#5-페이지별-기능)
  ...
  - [ETF 투자성향 분석 결과 페이지](#ETF-투자성향-분석-결과-페이지)
...
## 임재혁
 우선 프로젝트를 진행하며 고생한 팀원 장준규님과 팀장 한태호님에게 감사의 마음을 전하고 싶습니다.

 프로젝트를 진행하며 많은 부침이 있었고, 포기하고 적당한 수준에서 멈추고 싶었던 때가 많았습니다. 허나 팀원들의 많은 도움과 협력을 통해 포기보다는 도전의 값짐을 느꼈습니다.
 
 처음 배운 기술들인 JPA, REST API, React 등을 사용한 프로젝트였기에 시행착오가 많았고 완성도에 대한 확신은 없었으나 백엔드와 프론트엔드의 선명한 분류를 통해 역으로 백엔드와 프론트엔드 간의 협력에 대한 중요성을 다시금 깨닫게 되었으며, 사용할 수 있는 기술에 따라 좀 더 효율적이고 생산성이 뛰어난 개발을 해낼 수 있다는 것을 배웠습니다.
 
 프로젝트를 되돌아보며, 이제 두 번째 프로젝트이지만 첫 번째에 비해 발전한 자신을 느꼈고 이 프로젝트를 통해 기술적인 성장뿐만 아니라 팀워크의 중요성도 깊이 깨닫게 되었습니다. 시행착오 속에서도 끝까지 도전하며 얻은 경험들을 바탕으로 추후에는 더욱 효율적이고 완성도 높은 결과물을 만들고 싶습니다. 함께 노력해준 팀원들에게 다시 한번 감사드리며, 앞으로도 도전을 두려워하지 않는 개발자가 되도록 노력하겠습니다.

## 장준규
이번 Fund-Find 금융 플랫폼 프로젝트는 팀장 한태호, 팀원 임재혁, 그리고 저까지 총 세 명이 함께 진행한 국비 지원 교육 과정의 프로젝트였습니다. 이 프로젝트는 제가 두 번째로 참여한 사이트 제작 프로젝트로, 국비 과정에서 진행된 만큼 압도적인 퀄리티를 추구하기보다는 실무에서 필요한 기술과 협업 경험을 쌓는 데 중점을 두었습니다.

특히, 이번 프로젝트를 통해 JWT 인증 방식에 대해 깊이 이해할 수 있었고, 이를 실질적으로 구현하면서 인증 및 보안에 대한 자신감을 얻었습니다. 또한, 프론트엔드 툴을 처음으로 활용해 RESTful API 방식으로 개발을 진행하면서 보다 효율적이고 체계적인 개발 방법론을 배울 수 있었습니다.

팀원들과의 협업을 통해 작업의 흐름과 소통의 중요성을 다시금 느꼈으며, 기술적으로도 개인 역량을 한 단계 높일 수 있는 계기가 되었습니다. 배우고 성장하는 데 있어 매우 소중한 경험이었습니다.

앞으로도 이번 프로젝트에서 얻은 경험을 바탕으로 더 나은 서비스를 개발할 수 있도록 노력할 계획입니다.
